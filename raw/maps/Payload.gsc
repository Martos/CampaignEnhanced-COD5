...
PrecacheStuff()
{
	...
	// CUSTOM WEAPONS
	precacheItem( "m1garand_scoped_mp" );
	
	precacheItem( "fg42_telescopic_mp" );
	
	precacheItem( "mp40_aperture_mp" );
	precacheItem( "mp40_bigammo_mp" );
	precacheItem( "mp40_silenced_mp" );
	
	precacheItem( "thompson_aperture_mp" );
	precacheItem( "thompson_bigammo_mp" );
	precacheItem( "thompson_silenced_mp" );
	
	precacheItem( "ppsh_aperture_mp" );
	precacheItem( "ppsh_mp" );
	
	precacheItem( "stg44_aperture_mp" );
	precacheItem( "stg44_telescopic_mp" );
	precacheItem( "stg44_flash_mp" );
	
	precacheItem( "type100smg_aperture_mp" );
	precacheItem( "type100smg_bigammo_mp" );
	precacheItem( "type100smg_silenced_mp" );
	
	precacheItem( "gewehr43_aperture_mp" );
	precacheItem( "gewehr43_silenced_mp" );
	precacheItem( "gewehr43_telescopic_mp" );
}
